...
// PASTLWTR : 1.2
// File generated on 09.01.2005 13:40:46 from Type Library described below.

// ************************************************************************  //
// Type Lib: E:\src\wml\util\infotip\apooInfoTip.tlb (1)
...
const
  ...
  IID_IWMLColumn: TGUID = '{B4D5F9E3-A8E9-4845-BA36-B10B29928B3C}';
  CLASS_WMLColumn: TGUID = '{A6614304-6DFB-4A31-8032-C4E0CCA42D82}';
type
...
// *********************************************************************//
  ...
  IWMLColumn = interface;
  IWMLColumnDisp = dispinterface;
...
// *********************************************************************//
// Interface: IWMLColumn
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {B4D5F9E3-A8E9-4845-BA36-B10B29928B3C}
// *********************************************************************//
  IWMLColumn = interface(IDispatch)
    ['{B4D5F9E3-A8E9-4845-BA36-B10B29928B3C}']
  end;

// *********************************************************************//
// DispIntf:  IWMLColumnDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {B4D5F9E3-A8E9-4845-BA36-B10B29928B3C}
// *********************************************************************//
  IWMLColumnDisp = dispinterface
...
// *********************************************************************//
// The Class CoWMLColumn provides a Create and CreateRemote method to          
// create instances of the default interface IWMLColumn exposed by              
// the CoClass WMLColumn. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoWMLColumn = class
    class function Create: IWMLColumn;
    class function CreateRemote(const MachineName: string): IWMLColumn;
  end;
...
class function CoWMLColumn.Create: IWMLColumn;
begin
  Result := CreateComObject(CLASS_WMLColumn) as IWMLColumn;
end;

class function CoWMLColumn.CreateRemote(const MachineName: string): IWMLColumn;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_WMLColumn) as IWMLColumn;
end;
