...
// PASTLWTR : 1.2
// File generated on 12.10.2003 16:20:33 from Type Library described below.

// ************************************************************************  //
// Type Lib: E:\src\wml\plugins\AXComposerTaxonP.tlb (1)
// LIBID: {60099697-2157-4F91-8E45-E135F3D84BA3}
// LCID: 0
// Helpfile: 
// HelpString: AXComposerTaxonP Library
// DepndLst: 
//   (1) v2.0 stdole, (E:\WINDOWS\System32\stdole2.tlb)
//   (2) v4.0 StdVCL, (E:\WINDOWS\System32\stdvcl40.dll)
// ************************************************************************ //
...
const
  ...
  AXComposerTaxonPMajorVersion = 1;
  AXComposerTaxonPMinorVersion = 0;

  LIBID_AXComposerTaxonP: TGUID = '{60099697-2157-4F91-8E45-E135F3D84BA3}';

  IID_IAXComposerTaxon: TGUID = '{CDDEE3F6-3FC3-4D9C-895A-85C52CDA85F2}';
  DIID_IAXComposerTaxonEvents: TGUID = '{7608EEE4-1276-45FC-9B55-0EC054B9FEC7}';
  CLASS_AXComposerTaxon: TGUID = '{AB464A08-87F8-4B5A-BCF2-5F9E209A1E4F}';
...
// *********************************************************************//
  IAXComposerTaxon = interface;
  IAXComposerTaxonDisp = dispinterface;
  IAXComposerTaxonEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                       
// (NOTE: Here we map each CoClass to its Default Interface)              
// *********************************************************************//
  AXComposerTaxon = IAXComposerTaxon;
...
// *********************************************************************//
// Interface: IAXComposerTaxon
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {CDDEE3F6-3FC3-4D9C-895A-85C52CDA85F2}
// *********************************************************************//
  IAXComposerTaxon = interface(IDispatch)
    ['{CDDEE3F6-3FC3-4D9C-895A-85C52CDA85F2}']
...
// *********************************************************************//
// DispIntf:  IAXComposerTaxonEvents
// Flags:     (0)
// GUID:      {7608EEE4-1276-45FC-9B55-0EC054B9FEC7}
// *********************************************************************//
  IAXComposerTaxonEvents = dispinterface
    ['{7608EEE4-1276-45FC-9B55-0EC054B9FEC7}']
...
// Control Name     : TAXComposerTaxon
// Help String      : AXComposerTaxon Control
// Default Interface: IAXComposerTaxon
// Def. Intf. DISP? : No
// Event   Interface: IAXComposerTaxonEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TAXComposerTaxonOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TAXComposerTaxon = class(TOleControl)
  private
    ...
    FOnKeyPress: TAXComposerTaxonOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IAXComposerTaxon;
    function  GetControlInterface: IAXComposerTaxon;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    procedure AboutBox;
    property  ControlInterface: IAXComposerTaxon read GetControlInterface;
    property  DefaultInterface: IAXComposerTaxon read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TAXComposerTaxonOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TAXComposerTaxon.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{AB464A08-87F8-4B5A-BCF2-5F9E209A1E4F}';
    EventIID: '{7608EEE4-1276-45FC-9B55-0EC054B9FEC7}';
    EventCount: 8;
...
procedure TAXComposerTaxon.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IAXComposerTaxon;
  end;
...
function TAXComposerTaxon.GetControlInterface: IAXComposerTaxon;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TAXComposerTaxon]);
end;
