...
/** This class is an superclass to all other WapTables.
 *  It defines the error code returned by getCode().
 * @author Anders Mårtensson
 */

class WapTable {
    /** Returned by getCode if <PRE>name</PRE> is present in the table */
    public static final byte ERROR_CODE = (byte) 0xFF;

//     /** An exception class used if a code is not present in the table */
//     protected class CodeNotInTableException extends Exception {
