/****************************************************************************
** $Id: qrichtext_p.h,v 1.2 2001/03/21 20:58:50 stephanl Exp $
**
...
public:
        ...
        virtual bool breakLine() const
        {
                return ownLine();
        }
        enum Clear { ClearNone, ClearLeft, ClearRight, ClearBoth }; //  move to QStyleSheetItem?
        virtual Clear clearBehind() const
        {
                return ClearNone;
        }

        virtual bool noErase() const
        {
                return FALSE;
        };
        virtual bool expandsHorizontally() const
        {
                return FALSE;
        }
        virtual bool ownLine() const
        {
                return expandsHorizontally();
        };
...
public:
        ...
        bool expandsHorizontally() const
        {
                return TRUE;
        }
private:
...
public:
        ...
        int x() const
        {
                return currentx + currentoffsetx;
        }
...
public:
        ...
        QRect lineGeometry() const;
        QTextCharFormat* format() const;
        QTextParagraph* outmostParagraph() const
        {
                return fc.paragraph;
        }
