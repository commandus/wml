/* $Id: qsimplerichtextbis.cpp,v 1.2 2001/03/21 20:58:50 stephanl Exp $ */
/***************************************************************************
*   QWMLBrowser                                                            *
...
*/
QSimpleRichTextBis::QSimpleRichTextBis( const QString& text, const QFont& fnt,
...
*/
QSimpleRichTextBis::~QSimpleRichTextBis()
{
...
*/
void QSimpleRichTextBis::setWidth( int w)
{
        d->doc->doLayout( 0, w );
}
...
/*!
  ...
  \sa height(), adjustSize()
*/
void QSimpleRichTextBis::setWidth( QPainter* p, int w)
{
        d->doc->doLayout( p, w );
}
...
/*!
  ...
  \sa widthUsed()
*/
int QSimpleRichTextBis::width() const
{
...
/*!
  ...
  \sa width()
*/
int QSimpleRichTextBis::widthUsed() const
{
...
/*!
  ...
  \sa setWidth()
*/
int QSimpleRichTextBis::height() const
{
...
*/
void QSimpleRichTextBis::draw( QPainter* p,  int x, int y, const QRegion& clipRegion,
...
*/
QString QSimpleRichTextBis::context() const
{
...
*/
QString QSimpleRichTextBis::anchor( QPainter*, const QPoint& pos )
{
        return anchorAt( pos );
}
...
*/
QString QSimpleRichTextBis::anchorAt( const QPoint& pos ) const
{
...
/*!
  ...
  \sa setWidth()
*/
void QSimpleRichTextBis::adjustSize()
{
 ...
 */
bool QSimpleRichTextBis::inText( const QPoint& pos ) const
{
...
// member added
QRichText * QSimpleRichTextBis::richText() const
{
        return d->doc;
}
