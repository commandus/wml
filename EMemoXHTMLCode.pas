...
uses
  ...
  EMemo, EMemoCode, xmlsupported, customxml, xhtml;

type
  TEMemoXHTMLCode = class(TEMemoCode)
  private
...
constructor TEMemoXHTMLCode.Create(AOwner: TComponent);
begin
...
procedure TEMemoXHTMLCode.SetTagHTMLForeColor(AValue: TColor);
begin
  FTagHTMLForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagHTMLBackColor(AValue: TColor);
begin
  FTagHTMLBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagCommentForeColor(AValue: TColor);
begin
  FTagCommentForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagCommentBackColor(AValue: TColor);
begin
  FTagCommentBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagPCDataForeColor(AValue: TColor);
begin
  FTagPCDataForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagPCDataBackColor(AValue: TColor);
begin
  FTagPCDataBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagParaForeColor(AValue: TColor);
begin
  FTagParaForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagParaBackColor(AValue: TColor);
begin
  FTagParaBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagBlockForeColor(AValue: TColor);
begin
  FTagBlockForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagBlockBackColor(AValue: TColor);
begin
  FTagBlockBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagFormattingForeColor(AValue: TColor);
begin
  FTagFormattingForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagFormattingBackColor(AValue: TColor);
begin
  FTagFormattingBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagAnchorForeColor(AValue: TColor);
begin
  FTagAnchorForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagAnchorBackColor(AValue: TColor);
begin
  FTagAnchorBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagObjectForeColor(AValue: TColor);
begin
  FTagObjectForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagObjectBackColor(AValue: TColor);
begin
  FTagObjectBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagListForeColor(AValue: TColor);
begin
  FTagListForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagListBackColor(AValue: TColor);
begin
  FTagListBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagTableForeColor(AValue: TColor);
begin
  FTagTableForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagTableBackColor(AValue: TColor);
begin
  FTagTableBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagServerSideForeColor(AValue: TColor);
begin
  FTagServerSideForeColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SetTagServerSideBackColor(AValue: TColor);
begin
  FTagServerSideBackColor:= AValue;
  if FCodeHighlight and (FCxMemo <> nil) then FCxMemo.Invalidate;
end;

procedure TEMemoXHTMLCode.SelectTagColor(const ATag: TGsString; ACanvas: TCanvas);
var
  Tag: TGsString;
begin
...
procedure TEMemoXHTMLCode.DrawSpecialTag(const ASpecTag, Line: TGsString; ACanvas: TCanvas);
var
  p, SavePos: Integer;
...
function TEMemoXHTMLCode.GetClassDescription(var R: TxmlClassDesc): Boolean;
begin
  Result:= GetxmlClassDescByClass(THtmContainer, R);
end;

procedure TEMemoXHTMLCode.ParseLine(ALineNo: Integer; Canvas: TCanvas; ARect: TRect);
var
...
procedure TEMemoXHTMLCode.SetBackgroundColors(AColor: TColor);
begin
